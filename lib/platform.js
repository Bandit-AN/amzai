...
export const config = Object.freeze({
  ...
  productCooldownSeconds: integer(process.env.PRODUCT_COOLDOWN_SECONDS, 604800),
...
const variationHeavyTerms = /\b(?:shirt|pants|dress|shoe|sneaker|underwear|bra|jacket|tire|furniture|sofa|mattress|television|tv|freezer|refrigerator|appliance)\b/i;
